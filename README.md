...
- Clean HTML and CSS
- Python concepts:
    - [dictionary](/gaproject/util.py#L9), [set](../blob/master/gaproject/__init__.py#L60), or tuple
...
https://github.com/minhtrangvy/GAPythonInstructorFlaskApp/blob/master/master/gaproject/util.py#L9
## Routes
### /, /index
